...
export const APTeamDashboard: React.FC<ISonaEmdProps> = (props: ISonaEmdProps) => {
  ...
  // 🔹 Fetch Data: ONLY Pending for Vouching
  const GetListData = async () => {
    try {
      ...
      // ✅ Fetch only items Pending for Vouching
      //const filter = "Status eq 'Pending for Vouching'";
      const currentUserId = props.context.pageContext.legacyPageContext.userId;

      const filter = `Status eq 'Pending for Vouching' and CurrentApproverId eq ${currentUserId}`;
    ...
    <div className="dashboard-wrapper">
      ...
      <div className="filter-section">
        <div className="filter-left">
          ...
          />
          {/* No status dropdown here because this dashboard is dedicated to 'Pending for Vouching' */}
        </div>
      </div>
