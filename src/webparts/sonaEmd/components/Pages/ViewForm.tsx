    ...
    return (
        <div className="forex-wrapper">
            ...
            <div className="forex-card">
                ...
                {/* Action (Closure) */}
                {dateOfReceipt && (
                    <Section title="EMD Updated">
                        <Grid>
                            <Field label="Date of Receipt*">
                                <input type="date" readOnly value={dateOfReceipt} onChange={(e) => setDateOfReceipt(e.target.value)} />
                            </Field>
              ...
              <div style={{ marginTop: 8, color: "#6a6a6a", fontSize: 12 }}>
                ...
                <div className="button-row">
                    ...
                    <button className="btn-exit" onClick={() => history.goBack()}>
                        Exit
                    </button>
                </div>
            </div>
